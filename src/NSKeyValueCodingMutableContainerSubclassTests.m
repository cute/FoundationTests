...
//    [SubclassTracker dumpVerification:target];
    BOOL verified = [SubclassTracker verify:target commands:@selector(insertFoo:atIndexes:), @selector(count), @selector(count), @selector(count), @selector(count), @selector(insertObject:atIndex:), @selector(count), @selector(count), @selector(count), @selector(insertObject:atIndex:), nil];
    testassert(verified);
...
//    [SubclassTracker dumpVerification:target];
    BOOL verified = [SubclassTracker verify:target commands:@selector(replaceFooAtIndexes:withFoo:), @selector(count), @selector(count), @selector(removeObjectAtIndex:), @selector(count), @selector(removeObjectAtIndex:), @selector(count), @selector(count), @selector(count), @selector(insertObject:atIndex:), @selector(count), @selector(count), @selector(count), @selector(insertObject:atIndex:), nil];
    testassert(verified);
...
//    [SubclassTracker dumpVerification:target];
    BOOL verified = [SubclassTracker verify:target commands:@selector(foo), @selector(count), @selector(foo), @selector(count), @selector(count), @selector(count), @selector(objectAtIndex:), @selector(setFoo:), @selector(foo), @selector(count), @selector(foo), @selector(count), @selector(count), @selector(count), @selector(objectAtIndex:), @selector(objectAtIndex:), @selector(setFoo:), nil];
    testassert(verified);
...
//    [SubclassTracker dumpVerification:target];
    BOOL verified = [SubclassTracker verify:target commands:@selector(intersectFoo:), @selector(count), @selector(objectEnumerator), @selector(member:), @selector(member:), @selector(member:), @selector(count), @selector(objectEnumerator), @selector(member:), @selector(member:), @selector(member:), @selector(removeObject:), nil];
    testassert(verified);
...
//    [SubclassTracker dumpVerification:target];
    BOOL verified = [SubclassTracker verify:target commands:@selector(foo), @selector(count), @selector(foo), @selector(count), @selector(foo), @selector(objectEnumerator), @selector(foo), @selector(member:), nil];
    testassert(verified);
...
//    [SubclassTracker dumpVerification:target];
    BOOL verified = [SubclassTracker verify:target commands:@selector(foo), @selector(count), @selector(count), @selector(objectEnumerator), @selector(setFoo:), @selector(foo), @selector(count), @selector(count), @selector(objectEnumerator), @selector(setFoo:), nil];
    testassert(verified);
...
//    [SubclassTracker dumpVerification:target];
    BOOL verified = [SubclassTracker verify:target commands:@selector(foo), @selector(count), @selector(count), @selector(objectEnumerator), @selector(setFoo:), nil];
    testassert(verified);
